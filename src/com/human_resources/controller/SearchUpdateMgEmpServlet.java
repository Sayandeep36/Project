...
@WebServlet("/SearchUpdateMgEmpServlet")
public class SearchUpdateMgEmpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public SearchUpdateMgEmpServlet() {
        super();
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
    {
		...
		ArrayList<EmpInfo> f = cdao.searchMgRecord(eid);
		RequestDispatcher rs = request.getRequestDispatcher("UpdateProject.jsp");
