...
@WebServlet("/MGDisplayAllEmpServlet")
public class MGDisplayAllEmpServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    public MGDisplayAllEmpServlet() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException 
	{
		...
		ArrayList<EmpInfo> custlist = cdao.mgdisplayAllEmp();
					
		//CREATE LINK BETWEEN SEVLET TO JSP FILE
		RequestDispatcher rd = request.getRequestDispatcher("MGDisplayAllEmp.jsp");
